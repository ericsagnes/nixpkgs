...
let
  ...
  # the test function is called with and two extra parameters
  # - `nixosFolder` to including modules in an easy way
  # - `nixpkgsFolder` required to include files like nixos/lib/eval-config.nix
